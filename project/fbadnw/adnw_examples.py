...
"""
def run_async_request(app_id, access_token, platform, from_date, to_date):
...
def run_async_request_for_result(app_id, access_token, platform, from_date, to_date):
    query_id = run_async_request(app_id, access_token, platform, from_date, to_date)

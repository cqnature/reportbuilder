...
class ADNWRequestBuilder(object):
    ...
    def add_breakdowns(self, breakdowns):
    ...
    def set_ordering_type(self, ordering_type):
        self.ordering_type = ordering_type

    def set_ordering_column(self, ordering_column):
        self.ordering_column = ordering_column

    def set_aggregation_period(self, aggregation_period):
    ...
    def validate_params(self, is_sync_request = True, is_using_query_ids = False):

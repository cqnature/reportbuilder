...
class Report(BaseReport):
    ...
    def generate_lostplant_report_at_date(self, report_lines, date):
        ...
        with open(self.etc_filepath) as file:
            ...
            signup_base_datas[0][2] = 100 * \
                float(first_level_user_count)/float(firstopen_usercount)
            ...
            for single_date in Date(date).rangeto(self.get_retention_date(date)):
                ...
                if currentDayIndex == 1:
                    ...
                    lost_base_datas[0][1] = current_lost_usercount - \
                        sum(t[1] for t in lost_base_datas)
                    lost_base_datas[0][2] = 100 * \
                        float(lost_base_datas[0][1])/float(firstopen_usercount)
                    ...
                    current_lost_datas[0][1] = lost_base_usercount - \
                        sum(t[1] for t in current_lost_datas)
                    current_lost_datas[0][2] = 100 * \
                        float(current_lost_datas[0][1]) / \

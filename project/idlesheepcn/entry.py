...
from retentioneventreport import generate_retention_event_report
...
class Entry(BaseEntry):
    ...
    def do_generate_report(self):
        ...
        if self.option & ReportFlag.retention_event:
            report_filepaths.extend(generate_retention_event_report(
                self.query_config, self.start_date))
